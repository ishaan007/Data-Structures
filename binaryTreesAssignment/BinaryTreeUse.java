...
public class BinaryTreeUse {
	...
	public static int countNumNodes(BinaryTree<Integer> root) {
		if (root == null) {
			return 0;
		}
	...
	public static void printBT(BinaryTree<Integer> root) {
		if (root == null)
			return;
	...
	public static BinaryTree<Integer> takeBTInput() {
...
//		System.out.println(a + b);
		...
		BinaryTree<Integer> root = takeBTInput();
		printBT(root);
